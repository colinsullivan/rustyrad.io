 ...
 */
function rustyradio_custom_header_setup() {
	 ...
	 * }
	 */
	add_theme_support( 'custom-header', apply_filters( 'rustyradio_custom_header_args', array(
		'default-text-color'     => $default_text_color,
		'width'                  => 954,
		'height'                 => 1300,
		'wp-head-callback'       => 'rustyradio_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'rustyradio_custom_header_setup' );
 ...
 */
function rustyradio_hex2rgb( $color ) {
	$color = trim( $color, '#' );
...
if ( ! function_exists( 'rustyradio_header_style' ) ) :
/**
 ...
 */
function rustyradio_header_style() {
	...
	?>
	<style type="text/css" id="rustyradio-header-css">
	<?php
 ...
 */
function rustyradio_header_background_color_css() {
	$color_scheme            = rustyradio_get_color_scheme();
	...
	wp_add_inline_style( 'rustyradio-style', sprintf( $css, $header_background_color ) );
}
add_action( 'wp_enqueue_scripts', 'rustyradio_header_background_color_css', 11 );
...
function rustyradio_sidebar_text_color_css() {
	...
	// If we get this far, we have custom styles. Let's do this.
	$sidebar_link_color_rgb     = rustyradio_hex2rgb( $sidebar_link_color );
	...
	wp_add_inline_style( 'rustyradio-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'wp_enqueue_scripts', 'rustyradio_sidebar_text_color_css', 11 );
